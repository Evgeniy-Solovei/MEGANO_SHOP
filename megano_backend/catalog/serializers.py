...
from catalog.models import Category, Image, Product, Review, Sale, Tag
...
class ImageSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        return [{"src": instance.src.url, "alt": instance.alt}]
...
class SaleSerializer(serializers.ModelSerializer):
    ...
    price = serializers.DecimalField(
        source="product.price", decimal_places=2, max_digits=8, read_only=True
    )
